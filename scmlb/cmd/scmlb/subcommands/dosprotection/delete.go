...
var deleteCmd = cobra.Command{
	Use:   "delete",
	Short: "delete a DoS protection policy",
	RunE:  execDelete,
}

func init() {
	deleteCmd.Flags().Int32P("id", "i", 0, "DoS protection policy id to delete")

	deleteCmd.MarkFlagRequired("id")
}

func execDelete(cmd *cobra.Command, args []string) error {
	...
	if _, err := client.DoSProtectionPolicyDelete(cmd.Context(), &rpc.DoSProtectionPolicyDeleteRequest{
		Id: id,
	}); err != nil {
		return err
	}

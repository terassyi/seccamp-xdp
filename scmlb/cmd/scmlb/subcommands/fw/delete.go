...
var deleteCmd = cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := client.FireWallRuleDelete(cmd.Context(), &rpc.FireWallRuleDeleteRequest{
			Id: id,
		}); err != nil {
			return err
		}
...
func init() {
	deleteCmd.Flags().Int32P("id", "i", -1, "rule id to delete")
